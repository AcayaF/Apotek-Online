            ...
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                <form class="login100-form validate-form" action="auth/aksi.php" method="post">
                    ...
                    <div class="product-list">
                        <input type="hidden" name="kode_obat" value="1009">
                        <input type="hidden" name="id_user" value="<?php echo $id_user;?>">
                        <div>
                            <center><img src="gambar/konidin.jpg" alt="Gambar Obat" style="width:250px; height:150px;">
                            </center>
                            ...
                            <div>
                                <h2>Deskripsi</h2>
                                <p>Tablet konidin sebagai obat batuk diproduksi oleh PT Konimex. Dalam 1 tablet konidin
                                    mengandung guaifenesin, dextromethorphan Hbr, dan CTM. Dextromethorphan HBr termasuk
                                    golongan antitusif jadi cocok untuk batuk kering. Guaifenesin merupakan ekspektoran
                                    yang dapat membantu melegakan tenggorokan,
                                    sehingga batuk akan lebih mudah dilepaskan. Terakhir, CTM sering kita dengar
                                    digunakan sebagai antihistamin untuk alerginya.</p>
                                <div class="divider"></div>
                            </div>
                            ...
                            <div>
                                <h2>Aturan Pakai</h2>
                                <p>Dewasa dan anak-anak > 12 tahun: 3 x sehari 1-2 tablet; Anak-anak 6-12 tahun: 3 x
                                    sehari 1/2-1 tablet; Anak-anak 3-6 tahun: 3 x sehari 1/4-1/2 tablet.</p>
                                <div class="divider"></div>
                            </div>
                        </div>
                    </div>
