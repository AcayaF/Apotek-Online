            ...
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                <form class="login100-form validate-form" action="auth/aksi.php" method="post">
                    ...
                    <div class="product-list">
                        <input type="hidden" name="kode_obat" value="1001">
                        <input type="hidden" name="id_user" value="<?php echo $id_user;?>">
                        <div>
                            <center><img src="gambar/sunmol tablet.jpg" alt="Gambar Obat"></center>

                            <div>
                                <center>
                                    <h2><br>Sanmol Tablet</h2>
                                </center>
                            ...
                            <div>
                                <h2>Deskripsi</h2>
                                <p>Sanmol Tablet 500 mg adalah obat yang memiliki kandungan bahan aktif Paracetamol.
                                    Paracetamol bekerja dengan cara mengurangi kadar prostaglandin di dalam tubuh,
                                    sehingga tanda peradangan seperti demam dan nyeri akan berkurang.
                                    Obat ini digunakan untuk meringankan rasa sakit seperti sakit kepala, sakit gigi
                                    serta menurunkan demam.</p>
                                <div class="divider"></div>
                            </div>
                            ...
                            <div>
                                <h2>Indikasi Umum</h2>
                                <p>Meringankan rasa sakit seperti sakit kepala, sakit gigi dan menurunkan demam.</p>
                                <div class="divider"></div>
                            </div>

                            <div>
                                <h2>Aturan Pakai</h2>
                                <p>• Dewasa: 1-2 tablet, diberikan sebanyak 3-4 kali per hari.<br>
                                    • Anak usia 6-12 tahun: ½-1 tablet, diberikan sebanyak 3-4 kali per hari. </p>
                                <div class="divider"></div>
                            </div>
                        </div>
                    </div>
