            ...
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                <form class="login100-form validate-form" action="auth/aksi.php" method="post">
                    ...
                    <div class="product-list">
                        <input type="hidden" name="kode_obat" value="1071">
                        <input type="hidden" name="id_user" value="<?php echo $id_user;?>">
                        <div>
                            <center><img src="gambar/1071.jpg" alt="Gambar Obat"></center>

                            <div>
                                <center>
                                    <h2><br>Salep Miconazole</h2>
                                </center>
                                <br>Rp. 8.500 /Pcs<br>
                                <p><br>Stock : 15</p>
                            ...
                            <div>
                                <h2>Deskripsi</h2>
                                <p>MICONAZOLE merupakan obat topikal (penggunaan luar) yang digunakan untuk mengatasi
                                    infeksi jamur pada kulit, seperti kurap (tinea), kutu air, panu, dan candidiasis
                                    kulit. Miconazole bekerja dengan cara merusak struktur membran sel jamur, sehingga
                                    pertumbuhan jamur dapat dihentikan.</p>
                                <div class="divider"></div>
                            </div>
                            ...
                            <div>
                                <h2>Indikasi Umum</h2>
                                <p>Infeksi jamur seperti kurap, kutu air, panu, candidiasis kulit.</p>
                                <div class="divider"></div>
                            </div>

                            <div>
                                <h2>Aturan Pakai</h2>
                                <p>Oleskan 2 kali sehari selama 2–6 minggu.</p>
                                <div class="divider"></div>
                            </div>
                        </div>
                    </div>
