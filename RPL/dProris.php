            ...
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                <form class="login100-form validate-form" action="auth/aksi.php" method="post">
                    ...
                    <div class="product-list">
                        <input type="hidden" name="kode_obat" value="1029">
                        <input type="hidden" name="id_user" value="<?php echo $id_user;?>">
                        <div>
                            <center><img src="gambar/proris.png" alt="Gambar Obat" style="width:250px; height:150px;">
                            </center>
                            ...
                            <div>
                                <h2>Deskripsi</h2>
                                <p>Proris merupakan obat dengan kandungan bahan aktif ibuprofen 200 mg, yang dapat
                                    menurunkan demam pada anak-anak, dan meringankan nyeri ringan sampai sedang, yang
                                    disebabkan oleh sakit gigi, sakit kepala, nyeri setelah operasi, gejala nyeri ringan
                                    sampai sedang pada penyakit rematik tulang sendi dan non sendi, dan terkilir.
                                    Penggunaan Proris tidak dianjurkan bagi anak dibawah 1 tahun. Proris diproduksi oleh
                                    Pharos Indonesia.</p>
                                <div class="divider"></div>
                            </div>
                            ...
                            <div>
                                <h2>Indikasi Umum</h2>
                                <p>Meredakan nyeri & demam.</p>
                                <div class="divider"></div>
                            </div>

                            <div>
                                <h2>Aturan Pakai</h2>
                                <p>Dewasa : 200 mg 3-4 kali sehari. Menurunkan nyeri pada anak 1-2 tahun: 50 mg 3-4 kali
                                    sehari, usia 3-7 tahun: 100 mg 3-4 kali sehari, usia 8-12 tahun: 200 mg 3-4 kali
                                    sehari. Untuk menurunkan demam: anak usia 1-12 tahun: dengan temperatur >39 derajat
                                    celsius: 10 mg/kgBB/hari.</p>
                                <div class="divider"></div>
                            </div>
                        </div>
                    </div>
