            ...
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                <form class="login100-form validate-form" action="auth/aksi.php" method="post">
                    ...
                    <div class="product-list">
                        <input type="hidden" name="kode_obat" value="1057">
                        <input type="hidden" name="id_user" value="<?php echo $id_user;?>">
                        <div>
                            <center><img src="gambar/1057.jpg" alt="Gambar Obat"></center>

                            <div>
                                <center>
                                    <h2><br>Ipi Vitamin C</h2>
                                </center>
                            ...
                            <div>
                                <h2>Deskripsi</h2>
                                <p>VITAMIN C IPI merupakan suplemen untuk membantu memelihara daya tahan tubuh. Produk
                                    ini memiliki bahan aktif vitamin C.</p>
                                <div class="divider"></div>
                            </div>
                            ...
                            <div>
                                <h2>Aturan Pakai</h2>
                                <p>1 x sehari 1 tablet atau sesuai pada petunjuk kemasan.</p>
                                <div class="divider"></div>
                            </div>
                        </div>
                    </div>
