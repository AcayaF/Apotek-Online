            ...
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                <form class="login100-form validate-form" action="auth/aksi.php" method="post">
                    ...
                    <div class="product-list">
                        <input type="hidden" name="kode_obat" value="1018">
                        <input type="hidden" name="id_user" value="<?php echo $id_user;?>">
                        <div>
                            <center><img src="gambar/acarbose.jpg" alt="Gambar Obat" style="width:250px; height:150px;">
                            </center>
                            ...
                            <div>
                                <h2>Deskripsi</h2>
                                <p>ACARBOSE merupakan obat yang digunakan untuk menurunkan kadar gula darah yang
                                    meningkat pada penderita diabetes.</p>
                                <div class="divider"></div>
                            </div>
                            ...
                            <div>
                                <h2>Indikasi Umum</h2>
                                <p>Penurun gula darah bagi penderita kencing manis (diabetes mellitus).</p>
                                <div class="divider"></div>
                            </div>

                            <div>
                                <h2>Aturan Pakai</h2>
                                <p>Dewasa: Dosis awal 50 mg/hari, dapat ditingkatkan menjadi 50 mg, 3 kali sehari.
                                    Peningkatan dosis dapat ditingkatkan setelah 6-8 minggu menjadi 100-200 mg, 3 kali
                                    sehari jika dibutuhkan.</p>
                                <div class="divider"></div>
                            </div>
                        </div>
                    </div>
