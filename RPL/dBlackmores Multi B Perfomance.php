            ...
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                <form class="login100-form validate-form" action="auth/aksi.php" method="post">
                    ...
                    <div class="product-list">
                        <input type="hidden" name="kode_obat" value="1055">
                        <input type="hidden" name="id_user" value="<?php echo $id_user;?>">
                        <div>
                            <center><img src="gambar/1055.jpg" alt="Gambar Obat"></center>

                            <div>
                                <center>
                                    <h2><br>Blackmores Multi B Perfomance</h2>
                                </center>
                                <br>Rp. 175.000 /Botol<br>
                                <p><br>Stock : 3</p>
                            ...
                            <div>
                                <h2>Deskripsi</h2>
                                <p>BLACKMORES MULTI B PERFORMANCE merupakan suplemen yang mengandung kombinasi antara
                                    vitamin, mineral dan herbal yang digunakan untuk mengatasi stress, membantu
                                    relaksasi serta mengurangi ketegangan dan insomnia.</p>
                                <div class="divider"></div>
                            </div>

                            <div>
                                <h2>Komposisi</h2>
                                <p>Vitamin B1 67 mg, Vitamin B2 10 mg, Nicotinamide 100 mg, Vitamin B5 69 mg, Vitamin B6
                                    21 mg, Vitamin B12 30 mcg, Vitamin H 20 mcg, Asam askorbat 250 mg, Vitamin E 50 IU
                                    (34 mg), Magnesium 29 mg, Kalsium 37 mg, Kalium 34 mg, Asam folat 150 mcg, Ekstrak
                                    Avena sativa (oats) setara dengan biji kering 250 mg, Ekstrak Passiflora incarnata
                                    (passion flower) 100 mg, Lecitin 50 mg, Kolin bitartrat 10.28 mg, Inositol 25 mg.
                                </p>
                                <div class="divider"></div>
                            </div>
                            ...
                            <div>
                                <h2>Indikasi Umum</h2>
                                <p>Mengatasi stress, membantu relaksasi serta mengurangi ketegangan dan insomnia.</p>
                                <div class="divider"></div>
                            </div>

                            <div>
                                <h2>Aturan Pakai</h2>
                                <p>Dewasa : 1-2 tablet.</p>
                                <div class="divider"></div>
                            </div>
                        </div>
                    </div>
