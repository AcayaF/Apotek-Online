            ...
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                <form class="login100-form validate-form" action="auth/aksi.php" method="post">
                    ...
                    <div class="product-list">
                        <input type="hidden" name="kode_obat" value="1063">
                        <input type="hidden" name="id_user" value="<?php echo $id_user;?>">
                        <div>
                            <center><img src="gambar/1063.jpg" alt="Gambar Obat"></center>

                            <div>
                                <center>
                                    <h2><br>Cendo Cenfresh</h2>
                                </center>
                                <br>Rp. 46.500 /Botol<br>
                                <p><br>Stock : 12</p>
                            ...
                            <div>
                                <h2>Deskripsi</h2>
                                <p>Tetes mata untuk pembasah pada mata kering.</p>
                                <div class="divider"></div>
                            </div>

                            <div>
                                <h2>Komposisi</h2>
                                <p>Carmellose sodium 5mg.</p>
                                <div class="divider"></div>
                            </div>

                            <div>
                                <h2>Indikasi Umum</h2>
                                <p>Mengurangi iritasi pada mata kering. Melindungi mata terhadap iritasi lebih lanjut,
                                    mengurangi rasa tidak nyaman karena iritasi ringan, terkena angin dan sinar
                                    matahari.</p>
                                <div class="divider"></div>
                            </div>
                            ...
                            <div>
                                <h2>Aturan Pakai</h2>
                                <p>1-2 tetes pada mata yang sakit 3-4 kali sehari atau sesuai kebutuhan.</p>
                                <div class="divider"></div>
                            </div>
                        </div>
                    </div>
