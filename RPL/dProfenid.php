            ...
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                <form class="login100-form validate-form" action="auth/aksi.php" method="post">
                    ...
                    <div class="product-list">
                        <input type="hidden" name="kode_obat" value="1024">
                        <input type="hidden" name="id_user" value="<?php echo $id_user;?>">
                        <div>
                            <center><img src="gambar/profenid.jpeg" alt="Gambar Obat"
                            ...
                            <div>
                                <h2>Deskripsi</h2>
                                <p>Profenid adalah obat yang umum digunakan untuk mengobati nyeri arthritis atau sakit
                                    gigi yang parah hingga mengakibatkan radang gusi. Profenid termasuk obat golongan
                                    NonSteroidal Anti-inflammatory Drug (NSAID) derivat asam propionat.</p>
                                <div class="divider"></div>
                            </div>

                            <div>
                                <h2>Komposisi</h2>
                                <p>Ketoprofen 100 mg.</p>
                                <div class="divider"></div>
                            </div>

                            <div>
                                <h2>Indikasi Umum</h2>
                                <p>Reumatisme inflamatorik kronik, reumatisme abartikular, serangan gout atau
                                    kondrokalsinosis; artritis gout & poliartritis; skiatika & nyeri punggung bawah;
                                    eksaserbasi kongestif pd OA.</p>
                                <div class="divider"></div>
                            </div>

                            <div>
                                <h2>Aturan Pakai</h2>
                                <p>Masukkan 1 supp pd malam hr disertai dg penggunaan preparat oral. Jika digunakan
                                    sendiri (monoterapi), dosis anjuran 1 supp 2 kali sehari.</p>
                                <div class="divider"></div>
                            </div>
                        </div>
                    </div>
