            ...
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                <form class="login100-form validate-form" action="auth/aksi.php" method="post">
                    ...
                    <div class="product-list">
                        <input type="hidden" name="kode_obat" value="1073">
                        <input type="hidden" name="id_user" value="<?php echo $id_user;?>">
                        <div>
                            <center><img src="gambar/1073.jpg" alt="Gambar Obat" style="width:250px; height:150px;">
                            </center>

                            <div>
                                <center>
                                    <h2><br>Kalpanax Salep</h2>
                                </center>
                                <br>Rp. 8.000 /Pcs<br>
                                <p><br>Stock : 21</p>
                            ...
                            <div>
                                <h2>Deskripsi</h2>
                                <p>Kalpanax merupakan obat oles yang digunakan untuk mengatasi jamur di kulit seperti
                                    panu, kadas, kurap, kutu air hingga ruam popok.</p>
                                <div class="divider"></div>
                            </div>

                            <div>
                                <h2>Komposisi</h2>
                                <p>Miconazol nitrate 2%.</p>
                                <div class="divider"></div>
                            </div>

                            <div>
                                <h2>Indikasi Umum</h2>
                                <p>Gatal jamur dan penyakit jamur kulit.</p>
                                <div class="divider"></div>
                            </div>

                            <div>
                                <h2>Aturan Pakai</h2>
                                <p>Dioleskan 2 kali sehari. Lamanya terapi bervariasi antara 2-6 minggu tergantung dari
                                    tempat dan berat ringannya penyakit.</p>
                                <div class="divider"></div>
                            </div>
                        </div>
                    </div>
