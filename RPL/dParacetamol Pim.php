            ...
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                <form class="login100-form validate-form" action="auth/aksi.php" method="post">
                    ...
                    <div class="product-list">
                        <input type="hidden" name="kode_obat" value="1002">
                        <input type="hidden" name="id_user" value="<?php echo $id_user;?>">
                        <div>
                            <center><img src="gambar/paraceatmol pim.jpg" alt="Gambar Obat"
                                    style="width:250px; height:150px;"></center>

                            <div>
                                <center>
                                    <h2><br>Paracetamol Pim</h2>
                                </center>
                                <br>Rp. 3.500 /Strip<br>
                                <p><br>Stock : 10</p>
                            ...
                            <div>
                                <h2>Deskripsi</h2>
                                <p>Paracetamol (Acetaminophen) yaitu zat aktif yang memiliki aktivitas sebagai penurun
                                    demam/antipiretik
                                    dan pereda nyeri/analgesik yang bekerja dengan cara menghambat pembentukan
                                    prostaglandin yaitu zat
                                    yang memicu nyeri dan demam di hipotalamus untuk meningkatkan pelepasan panas supaya
                                    suhu tubuh normal.</p>
                                <div class="divider"></div>
                            </div>
                            ...
                            <div>
                                <h2>Indikasi Umum</h2>
                                <p>Sebagai analgesik dan antipiretik.</p>
                                <div class="divider"></div>
                            </div>

                            <div>
                                <h2>Aturan Pakai</h2>
                                <p>Dewasa: 4 kali sehari 1 tablet.</p>
                                <div class="divider"></div>
                            </div>
                        </div>
                    </div>
