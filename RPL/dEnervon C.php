            ...
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                <form class="login100-form validate-form" action="auth/aksi.php" method="post">
                    ...
                    <div class="product-list">
                        <input type="hidden" name="kode_obat" value="1060">
                        <input type="hidden" name="id_user" value="<?php echo $id_user;?>">
                        <div>
                            <center><img src="gambar/1060.jpg" alt="Gambar Obat"></center>

                            <div>
                                <center>
                                    <h2><br>Enervon C</h2>
                                </center>
                                <br>Rp. 41.000 /Botol<br>
                                <p><br>Stock : 35</p>
                            ...
                            <div>
                                <h2>Deskripsi</h2>
                                <p>Enervon C adalah Suplemen vitamin yang dapat digunakan untuk membantu menjaga daya
                                    tahan tubuh. Enervon C mempunyai kandungan vitamin C dan B komplek yang dapat
                                    membantu daya tahan tubuh tetap prima serta dapat membantu proses pemulihan setelah
                                    sakit.</p>
                                <div class="divider"></div>
                            </div>
                            ...
                            <div>
                                <h2>Komposisi</h2>
                                <p>Vitamin c 500mg, niasinamida 50 mg, kalsium pantotenat 20 mg, vitamin b1 50 mg,
                                    vitamin b2 25 mg, vitamin b6 10 mg, vitamin b12 5 mcg.</p>
                                <div class="divider"></div>
                            </div>
