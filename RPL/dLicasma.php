            ...
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                <form class="login100-form validate-form" action="auth/aksi.php" method="post">
                    ...
                    <div class="product-list">
                        <input type="hidden" name="kode_obat" value="1068">
                        <input type="hidden" name="id_user" value="<?php echo $id_user;?>">
                        <div>
                            <center><img src="gambar/1068.jpg" alt="Gambar Obat"></center>

                            <div>
                                <center>
                                    <h2><br>Licasma</h2>
                                </center>
                                <br>Rp. 110.000 /Botol<br>
                                <p><br>Stock : 35</p>
                            ...
                            <div>
                                <h2>Deskripsi</h2>
                                <p>LICASMA (Liquid Concentrate Extract For Asthma) merupakan herbal yang diracik dan
                                    diformulasikan khusus untuk kesehatan pernapasan. Menggunakan madu sebagai bahan
                                    dasar, LICASMA terbukti ampuh mengobati berbagai macam gangguan pernapasan.</p>
                                <div class="divider"></div>
                            </div>

                            <div>
                                <h2>Komposisi</h2>
                                <p>Daun Saga, Daun Cakar Ayam, Kayu Manis, Habbatusauda, Jahe.</p>
                                <div class="divider"></div>
                            </div>

                            <div>
                                <h2>Indikasi Umum</h2>
                                <p>Mengobati berbagai macam gangguan pernapasan.</p>
                                <div class="divider"></div>
                            </div>

                            <div>
                                <h2>Aturan Pakai</h2>
                                <p>Satu sendok makan Licasma ditambahkan air sebanyak 50 ml (¼ gelas) diminum dengan 3x
                                    tegukan 3x sehari.</p>
                                <div class="divider"></div>
                            </div>
                        </div>
