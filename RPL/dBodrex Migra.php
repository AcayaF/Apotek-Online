            ...
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                <form class="login100-form validate-form" action="auth/aksi.php" method="post">
                    ...
                    <div class="product-list">
                        <input type="hidden" name="kode_obat" value="1028">
                        <input type="hidden" name="id_user" value="<?php echo $id_user;?>">
                        <div>
                            <center><img src="gambar/bodrex migra.png" alt="Gambar Obat"
                                    style="width:250px; height:150px;"></center>

                            <div>
                                <center>
                                    <h2><br>Bodrex Migra</h2>
                                </center>
                            ...
                            <div>
                                <h2>Deskripsi</h2>
                                <p>Membantu meringankan rasa sakit kepala pada migrain.</p>
                                <div class="divider"></div>
                            </div>
