            ...
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                <form class="login100-form validate-form" action="auth/aksi.php" method="post">
                    ...
                    <div class="product-list">
                        <input type="hidden" name="kode_obat" value="1050">
                        <input type="hidden" name="id_user" value="<?php echo $id_user;?>">
                        <div>
                            <center><img src="gambar/1050.jpg" alt="Gambar Obat"></center>

                            <div>
                                <center>
                                    <h2><br>Blackmores Vitamin A</h2>
                                </center>
                                <br>Rp. 350.000 /Botol<br>
                                <p><br>Stock : 15</p>
                            ...
                            <div>
                                <h2>Deskripsi</h2>
                                <p>Blackmores Vitamin A 5000IU adalah sumber vitamin A yang lengkap, penting untuk
                                    penglihatan siang dan malam.
                                    Vitamin A juga penting untuk kesehatan kulit dan pemeliharaan selaput lendir yang
                                    sehat, yang merupakan garis pertahanan pertama melawan infeksi.</p>
                                <div class="divider"></div>
                            </div>

                            <div>
                                <h2>Komposisi</h2>
                                <p>Retinol palmitate (vitamin A 5000 IU) 2,75 mg (setara dengan 1500 mikrogram retinol).
                                </p>
                                <div class="divider"></div>
                            </div>
                            ...
                            <div>
                                <h2>Indikasi Umum</h2>
                                <p>Menjaga kesehatan fungsi mata; Menjaga penglihatan yang sehat; Membantu meningkatkan
                                    / menjaga kesehatan penglihatan di malam hari.</p>
                                <div class="divider"></div>
                            </div>

                            <div>
                                <h2>Aturan Pakai</h2>
                                <p>Dewasa: Minum 1 kapsul sekali sehari atau sesuai resep dokter.</p>
                                <div class="divider"></div>
                            </div>
                        </div>
                    </div>
