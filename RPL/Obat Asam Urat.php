            ...
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                <form class="login100-form validate-form" action="auth/auth.php" method="post">
                    ...
                    <div class="product-list">
                        ...
                        <div class="product-card">
                            <img class="product-image" src="gambar/aclonac.jpg" alt="Product 23">
                            <div class="product-info">
                                <div class="product-title">Aclonac</div>
                                <div class="product-price">Rp. 13.000 /Strip</div>
                                <center><a href="dAclonac.php" class="btn btn-primary">Buy Now</a></center>
                            </div>
                        </div>
                        <div class="product-card">
                            <img class="product-image" src="gambar/profenid.jpeg" alt="Product 24">
                            <div class="product-info">
                                <div class="product-title">Profenid</div>
                                <div class="product-price">Rp. 24.000 /Strip</div>
                                <center><a href="dProfenid.php" class="btn btn-primary">Buy Now</a></center>
                            </div>
                        </div>
                    </div>
                    <br><br><br><br><br><br>
