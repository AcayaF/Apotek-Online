            ...
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                <form class="login100-form validate-form" action="auth/aksi.php" method="post">
                    ...
                    <div class="product-list">
                        <input type="hidden" name="kode_obat" value="1030">
                        <input type="hidden" name="id_user" value="<?php echo $id_user;?>">
                        <div>
                            <center><img src="gambar/termofen sirup.jpg" alt="Gambar Obat"
                                    style="width:250px; height:150px;"></center>

                            <div>
                                <center>
                                    <h2><br>Termofen Sirup</h2>
                                </center>
                                <br>Rp. 30.000 /Botol<br>
                                <p><br>Stock : 7</p>
                            ...
                            <div>
                                <h2>Deskripsi</h2>
                                <p>TERMOFEN merupakan obat sirup yang digunakan untuk menurunkan demam pada anak-anak
                                    serta meringankan nyeri ringan hingga sedang seperti: *Sakit gigi *Sakit kepala
                                    *Nyeri akibat pencabutan gigi *Nyeri setelah operasi dan terkilir Setiap 5 ml (1
                                    sendok takar) Termofen suspensi 100 mg/5 ml mengandung: *Ibuprofen 100 mg TERMOFEN
                                    100MG/5ML SUSP 60ML memiliki mekanisme kerja dengan cara menghambat enzim
                                    siklooksigenase sehingga konversi asam arakidonat menjadi terganggu serta
                                    menghalangi tubuh memproduksi prostaglandin, yaitu senyawa yang menyebabkan
                                    peradangan dan rasa sakit.</p>
                                <div class="divider"></div>
                            </div>

                            <div>
                                <h2>Komposisi</h2>
                                <p>Ibuprofen 100 mg.</p>
                                <div class="divider"></div>
                            </div>

                            <div>
                                <h2>Indikasi Umum</h2>
                                <p>Menurunkan demam pada anak-anak *Meringankan nyeri ringan hingga sedang seperti sakit
                                    gigi, sakit kepala, nyeri akibat pencabutan gigi, nyeri setelah operasi dan
                                    terkilir.</p>
                                <div class="divider"></div>
                            </div>
