            ...
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                <form class="login100-form validate-form" action="auth/aksi.php" method="post">
                    ...
                    <div class="product-list">
                        <input type="hidden" name="kode_obat" value="1022">
                        <input type="hidden" name="id_user" value="<?php echo $id_user;?>">
                        <div>
                            <center><img src="gambar/recolfar.jpg" alt="Gambar Obat" style="width:250px; height:150px;">
                            </center>
                            ...
                            <div>
                                <h2>Deskripsi</h2>
                                <p>Recolfar merupakan obat yang digunakan untuk mengatasi rasa yeri akibat serangan
                                    mendadak pada gejala asam urat (gout) yang biasanya menyerang satu atau beberapa
                                    sendi jari kaki, lutut atau pergelangan kaki. Recolfar mengandung zat aktif
                                    Colchicine yang bekerja dengan menghambat siklus kristal garam urat pada jaringan
                                    sendi agar tidak terbentuk dan menghambat proses peradangan yang menjadi penyebab
                                    serangan gout akut.</p>
                                <div class="divider"></div>
                            </div>
                            ...
                            <div>
                                <h2>Indikasi Umum</h2>
                                <p>Arthritis gout akut dan pencegahan gout.</p>
                                <div class="divider"></div>
                            </div>

                            <div>
                                <h2>Aturan Pakai</h2>
                                <p>Gout artritis akut:0,5-1,2mg per hari (serangan akut:4-8mg), pencegahan gout: 0,5 mg
                                    sekali seminggu hingga sekali sehari.</p>
                                <div class="divider"></div>
                            </div>
                        </div>
                    </div>
