            ...
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                <form class="login100-form validate-form" action="auth/aksi.php" method="post">
                    ...
                    <div class="product-list">
                        <input type="hidden" name="kode_obat" value="1065">
                        <input type="hidden" name="id_user" value="<?php echo $id_user;?>">
                        <div>
                            <center><img src="gambar/1065.jpg" alt="Gambar Obat"></center>
                            ...
                            <div>
                                <h2>Deskripsi</h2>
                                <p>Teofilin adalah obat bronkodilator yang digunakan dalam penatalaksanaan asthma dan
                                    penyakit paru obstruktif kronis (PPOK).</p>
                                <div class="divider"></div>
                            </div>
                            ...
                            <div>
                                <h2>Indikasi Umum</h2>
                                <p>Untuk mengatasi gejala asma, bronkitis, emfisema, dan penyakit paru-paru lainnya.</p>
                                <div class="divider"></div>
                            </div>

                            <div>
                                <h2>Aturan Pakai</h2>
                                <p>-Dewasa: 200 mg setiap 12 jam. Dapat ditingkatkan menjadi 300–400 mg setiap 12 jam.
                                    Dosis maksimal 600 mg per hari.<br>
                                    -Anak-anak (di atas 6 tahun): disesuaikan dengan berat badan, usia, dan tingkat
                                    permasalahan pada saluran pernapasan. Dosis awal umumnya 12–14 mg/kg dengan dosis
                                    maksimal 600 mg per hari.</p>
                                <div class="divider"></div>
                            </div>
                        </div>
                    </div>
