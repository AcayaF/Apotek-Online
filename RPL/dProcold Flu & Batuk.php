            ...
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                <form class="login100-form validate-form" action="auth/aksi.php" method="post">
                    ...
                    <div class="product-list">
                        <input type="hidden" name="kode_obat" value="1006">
                        <input type="hidden" name="id_user" value="<?php echo $id_user;?>">
                        <div>
                            <center><img src="gambar/procold.png" alt="Gambar Obat" style="width:250px; height:150px;">
                            </center>

                            <div>
                                <center>
                                    <h2><br>Procold Flu & Batuk</h2>
                                </center>
                            ...
                            <div>
                                <h2>Deskripsi</h2>
                                <p>Procold merupakan obat untuk meringankan gejala flu seperti demam, sakit kepala,
                                    hidung tersumbat dan bersin-bersin yang disebabkan oleh alergi pada saluran
                                    pernapasan atas.</p>
                                <div class="divider"></div>
                            </div>
                            ...
                            <div>
                                <h2>Komposisi</h2>
                                <p>Paracetamol 500 mg, Pseudoefedrin 30 mg, Klorfeniramin maleat 2 mg.</p>
                                <div class="divider"></div>
                            </div>

                            <div>
                                <h2>Indikasi Umum</h2>
                                <p>Gejala flu, rhinitis alergi, pilek, dan hidung tersumbat.</p>
                                <div class="divider"></div>
                            </div>

                            <div>
                                <h2>Aturan Pakai</h2>
                                <p>Dewasa: 1 caplet, Anak-anak 6-12 tahun: ½ caplet.</p>
                                <div class="divider"></div>
                            </div>
                        </div>
                    </div>
