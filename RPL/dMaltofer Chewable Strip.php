            ...
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                <form class="login100-form validate-form" action="auth/aksi.php" method="post">
                    ...
                    <div class="product-list">
                        <input type="hidden" name="kode_obat" value="1048">
                        <input type="hidden" name="id_user" value="<?php echo $id_user;?>">
                        <div>
                            <center><img src="gambar/1048.jpg" alt="Gambar Obat" style="width:250px; height:150px;">
                            </center>

                            <div>
                                <center>
                                    <h2><br>Maltofer Chewable Strip</h2>
                                </center>
                                <br>Rp. 21.000 /Strip<br>
                                <p><br>Stock : 22</p>
                            ...
                            <div>
                                <h2>Deskripsi</h2>
                                <p>Tablet obat kunyah dengan rasa coklat yang enak dan tidak amis, digunakan dalam
                                    terapi defisiensi fe atau zat besi.</p>
                                <div class="divider"></div>
                            </div>

                            <div>
                                <h2>Komposisi</h2>
                                <p>Setiap tablet kunyah mengandung 100 mg zat besi sebagai Kompleks Besi (III)-hidroksi
                                    polimaltosa dan 0.35 mg asam folat.</p>
                                <div class="divider"></div>
                            </div>

                            <div>
                                <h2>Indikasi Umum</h2>
                                <p>Untuk pengobatan defisiensi zat besi laten dan anemia (gejala defisiensi zat besi)
                                    dan untuk pencegahan defisiensi zat besi dan asam folat pada masa sebelum, selama,
                                    dan setelah masa kehamilan serta selama masa menyusui.</p>
                                <div class="divider"></div>
                            </div>

                            <div>
                                <h2>Aturan Pakai</h2>
                                <p>Pengobatan : Konsultasikan dengan dokter Pencegahan kekurangan zat besi dan asam
                                    folat : 1 tablet sehari. Maltofer tablet dapat dikunyah atau ditelan langsung dan
                                    harus dikonsumsi selama atau segera setelah makan.</p>
                                <div class="divider"></div>
                            </div>
                        </div>
                    </div>
