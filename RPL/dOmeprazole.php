            ...
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                <form class="login100-form validate-form" action="auth/aksi.php" method="post">
                    ...
                    <div class="product-list">
                        <input type="hidden" name="kode_obat" value="1011">
                        <input type="hidden" name="id_user" value="<?php echo $id_user;?>">
                        <div>
                            <center><img src="gambar/omeprazole.jpg" alt="Gambar Obat"></center>

                            <div>
                                <center>
                                    <h2><br>Omeprazole</h2>
                                </center>
                                <br>Rp. 6.000 /Strip<br>
                                <p><br>Stock : 12</p>
                            ...
                            <div>
                                <h2>Deskripsi</h2>
                                <p>Omeprazole Novell merupakan obat generik dengan zat aktif Omeprazole yang digunakan
                                    untuk mengatasi penyakit-penyakit yang disebabkan oleh kelebihan produksi asam
                                    lambung, seperti sakit maag dan tukak lambung.</p>
                                <div class="divider"></div>
                            </div>
                            ...
                            <div>
                                <h2>Indikasi Umum</h2>
                                <p>Terapi jangka pendekulkus duodenal dan lambung. Refluks esofagitis, sindroma
                                    Zollinger-Ellison.</p>
                                <div class="divider"></div>
                            </div>
                            ...
                            <div>
                                <h2>Aturan Pakai</h2>
                                <p>> 12 th : 20 mg/hari selama 2-4 minggu; Pasien yang sukar disembuhkan dengan terapi :
                                    40 mg/hari selama 4-8 minggu.</p>
                                <div class="divider"></div>
                            </div>
                        </div>
                    </div>
