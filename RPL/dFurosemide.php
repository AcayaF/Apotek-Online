            ...
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                <form class="login100-form validate-form" action="auth/aksi.php" method="post">
                    ...
                    <div class="product-list">
                        <input type="hidden" name="kode_obat" value="1038">
                        <input type="hidden" name="id_user" value="<?php echo $id_user;?>">
                        <div>
                            <center><img src="gambar/1038.jpg" alt="Gambar Obat"></center>

                            <div>
                                <center>
                                    <h2><br>Furosemide</h2>
                                </center>
                                <br>Rp. 2.000 /Strip<br>
                                <p><br>Stock : 22</p>
                            ...
                            <div>
                                <h2>Deskripsi</h2>
                                <p>Furosemide merupakan obat golongan diuretik yang bekerja dengan menghambat absorpsi
                                    natrium dan klorida pada tubulus proksimal, tubulus distal, dan lengkung Henle, hal
                                    ini menyebabkan aliran darah ke ginjal meningkat, dan tekanan darahpun menurun.</p>
                                <div class="divider"></div>
                            </div>
                            ...
                            <div>
                                <h2>Indikasi Umum</h2>
                                <p>Pengobatan edema pada jantung, sirosis hati dan gangguan ginjal. Pengobatan
                                    hipertensi, baik diberikan dosis tunggal atau kombinasi dengan obat antihipertensi
                                    Sub Kategori.</p>
                                <div class="divider"></div>
                            </div>
                            ...
                            <div>
                                <h2>Aturan Pakai</h2>
                                <p>Dosis edema yang berhubungan dengan gagal jantung, sirosis hati, dan penyakit ginjal
                                    : Dewasa 20-80 mg dosis tunggal, dapat ditingkatkan 20-40 mg tiap 6-8 jam.
                                    Hipertensi ringan - sedang, terapi tunggal atau kombinasi dengan obat antihipertensi
                                    lainnya dosis awal 40 mg 2x sehari.</p>
                                <div class="divider"></div>
                            </div>
                        </div>
                    </div>
