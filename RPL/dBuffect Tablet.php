...
<body style="overflow: auto;">
            ...
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                <form class="login100-form validate-form" action="auth/aksi.php" method="post">
                    ...
                    <div class="product-list">
                        <input type="hidden" name="kode_obat" value="1005">
                        <input type="hidden" name="id_user" value="<?php echo $id_user;?>">
                        <div>
                            <center><img src="gambar/buffet tablet.jpg" alt="Gambar Obat" style="width:250px; height:150px;"></center>

                        <div>
                            <center><h2><br>Buffect Tablet</h2></center>
                            <br>Rp. 4.000 /Strip<br>
                            <p><br>Stock : 20</p>
                        ...
                        <div>
                            <h2>Deskripsi</h2>
                            <p>Buffect mengandung zat aktif Ibuprofen yang didistribusikan oleh Sanbe. 
                                Buffect diindikasikan untuk nyeri ringan sampai dengan sedang seperti nyeri pasca operasi, nyeri pada penyakit reumatik, nyeri otot, dan untuk meredakan demam.</p>
                            <div class="divider"></div>
                        </div>
                        ...
                        <div>
                            <h2>Indikasi Umum</h2>
                            <p>Untuk nyeri ringan sampai dengan sedang seperti nyeri pasca operasi, 
                                nyeri pada penyakit reumatik, nyeri otot, dan untuk meredakan demam.</p>
                            <div class="divider"></div>
                        </div>

                        <div>
                            <h2>Aturan Pakai</h2>
                            <p>Buffect tablet Dewasa & Anak 8-12 tahun 1 tablet, 3-7 tahun ½ tablet, 1-2 tahun ¼ tablet. Diberikan 3-4 kali perhari.</p>
                            <div class="divider"></div>
                        </div>
                    </div>
            </div>
                    ...
                    <div class="item-container">
                        ...
                        <div class="quantity-buttons">
                          ...
                          <input type="text" id="quantity" class="quantity-input" name="jumlah" value="<?php echo $jml; ?>">
                    ...
                    <span class="login100-form-title p-b-0">
                        <div class="navbar">
                            ...
                            <a href="chat.html" class="navbar-item">
                                <i class="navbar-icon fa fa-comments"></i>
                                <br>Chat
                            </a>
    ...
    <script>
        ...
        function buyNow() {
            // Tambahkan logika untuk melakukan pembelian sekarang
            var quantityInput = document.getElementById('quantity');
            var quantity = parseInt(quantityInput.value);
            // ...
        }
