            ...
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                <form class="login100-form validate-form" action="auth/aksi.php" method="post">
                    ...
                    <div class="product-list">
                        <input type="hidden" name="kode_obat" value="1042">
                        <input type="hidden" name="id_user" value="<?php echo $id_user;?>">
                        <div>
                            <center><img src="gambar/1042.jpg" alt="Gambar Obat"></center>

                            <div>
                                <center>
                                    <h2><br>Amlodipine</h2>
                                </center>
                                <br>Rp. 8.000 /Strip<br>
                                <p><br>Stock : 9</p>
                            ...
                            <div>
                                <h2>Deskripsi</h2>
                                <p>Amlodipin merupakan obat golongan antagonis kalsium yang bekerja dengan menghambat
                                    arus masuk ion kalsium di dalam membran sel aktif.</p>
                                <div class="divider"></div>
                            </div>
                            ...
                            <div>
                                <h2>Indikasi Umum</h2>
                                <p>Terapi dan profilaksis terhadap angina pektoris (nyeri dada) dan hipertensi.</p>
                                <div class="divider"></div>
                            </div>

                            <div>
                                <h2>Aturan Pakai</h2>
                                <p>1 x perhari (5 mg) maksimal pemberian 10 mg/hari.</p>
                                <div class="divider"></div>
                            </div>
                        </div>
                    </div>
