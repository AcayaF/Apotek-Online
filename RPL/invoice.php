        ...
        <div class="container-login100" style="background-image: url('images/bg-01.jpg');">
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                <form class="login100-form validate-form" action="auth/aksi.php" method="post">
                    ...
                    <div style="height: 598px;"><br><br><br><br><br><br><br><center><h3 style="text-align: center;">Pesanan anda telah diterima, Silahkan menuju history untuk melihat riwayat pesanan anda</h3></center></div>
