            ...
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                <form class="login100-form validate-form" action="auth/aksi.php" method="post">
                    ...
                    <div class="product-list">
                        <input type="hidden" name="kode_obat" value="1045">
                        <input type="hidden" name="id_user" value="<?php echo $id_user;?>">
                        <div>
                            <center><img src="gambar/1045.jpg" alt="Gambar Obat"></center>

                            <div>
                                <center>
                                    <h2><br>Tonikum Bayer</h2>
                                </center>
                                <br>Rp. 16.500 /Botol<br>
                                <p><br>Stock : 11</p>
                            ...
                            <div>
                                <h2>Komposisi</h2>
                                <p>Vitamin B1, vitamin B2, vitamin B3, vitamin B6, vitamin B12, vitamin C, ferro
                                    gluconate, calcium gloconate, mangan sulfate, dan zinc sulfate.</p>
                                <div class="divider"></div>
                            </div>

                            <div>
                                <h2>Indikasi Umum</h2>
                                <p>Pelengkap vitamin pada keadaan kekurangan vitamin.</p>
                                <div class="divider"></div>
                            </div>
