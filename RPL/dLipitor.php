            ...
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                <form class="login100-form validate-form" action="auth/aksi.php" method="post">
                    ...
                    <div class="product-list">
                        <input type="hidden" name="kode_obat" value="1017">
                        <input type="hidden" name="id_user" value="<?php echo $id_user;?>">
                        <div>
                            <center><img src="gambar/lipitor.png" alt="Gambar Obat" style="width:250px; height:150px;">
                            </center>
                            ...
                            <div>
                                <h2>Deskripsi</h2>
                                <p>LIPITOR memiliki kandungan bahan aktif Atorvastatin. Atorvastatin merupakan obat yang
                                    digunakan untuk menurunkan kolesterol jahat (LDL) dan trigliserida serta
                                    meningkatkan jumlah kolesterol baik (HDL) di dalam darah. Obat ini bekerja dengan
                                    cara menghambat enzim yang memproduksi kolesterol di hati.</p>
                                <div class="divider"></div>
                            </div>

                            <div>
                                <h2>Komposisi</h2>
                                <p>Atorvastatin 80 mg.</p>
                                <div class="divider"></div>
                            </div>

                            <div>
                                <h2>Indikasi Umum</h2>
                                <p>Menurunkan kolesterol jahat (LDL) dan trigliserida serta meningkatkan jumlah
                                    kolesterol baik (HDL) di dalam darah.</p>
                                <div class="divider"></div>
                            </div>

                            <div>
                                <h2>Aturan Pakai</h2>
                                <p>• Dewasa: Dosis awal adalah 10-20 mg sekali sehari.<br>
                                    • Anak-anak usia ? 10 tahun: 10 mg sekali sehari.</p>
                                <div class="divider"></div>
                            </div>
                        </div>
                    </div>
