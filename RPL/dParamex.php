            ...
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                <form class="login100-form validate-form" action="auth/aksi.php" method="post">
                    ...
                    <div class="product-list">
                        <input type="hidden" name="kode_obat" value="1025">
                        <input type="hidden" name="id_user" value="<?php echo $id_user;?>">
                        <div>
                            <center><img src="gambar/paramex.jpg" alt="Gambar Obat"></center>
                            ...
                            <div>
                                <h2>Deskripsi</h2>
                                <p>Paramex merupakan obat yang digunakan untuk meredakan demam dan rasa nyeri atau sakit
                                    kepala ataupun sakit gigi.</p>
                                <div class="divider"></div>
                            </div>

                            <div>
                                <h2>Komposisi</h2>
                                <p>Paracetamol 250mg, Propyphenazone 150 mg, Caffeine 50 mg, Decchlorpheniramine maleate
                                    1 mg.</p>
                                <div class="divider"></div>
                            </div>
                            ...
                            <div>
                                <h2>Aturan Pakai</h2>
                                <p>> 12 tahun : 2-3 kali sehari 1 tablet.</p>
                                <div class="divider"></div>
                            </div>
                        </div>
                    </div>
