            ...
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                <form class="login100-form validate-form" action="auth/aksi.php" method="post">
                    ...
                    <div class="product-list">
                        <input type="hidden" name="kode_obat" value="1026">
                        <input type="hidden" name="id_user" value="<?php echo $id_user;?>">
                        <div>
                            <center><img src="gambar/oskadon.png" alt="Gambar Obat" style="width:250px; height:150px;">
                            </center>
                            ...
                            <div>
                                <h2>Deskripsi</h2>
                                <p>Oskadon merupakan obat sakit kepala keluarga yang juga dapat mengurangi nyeri otot,
                                    nyeri saraf dan nyeri gigi.</p>
                                <div class="divider"></div>
                            </div>
                            ...
                            <div>
                                <h2>Indikasi Umum</h2>
                                <p>Sakit kepala, migrain, nyeri otot dan nyeri sendi, nyeri saraf, sakit gigi dan demam
                                    yang berhubungan dengan flu dan masuk angin.</p>
                                <div class="divider"></div>
                            </div>
