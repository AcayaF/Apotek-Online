            ...
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                <form class="login100-form validate-form" action="auth/aksi.php" method="post">
                    ...
                    <div class="product-list">
                        <input type="hidden" name="kode_obat" value="1069">
                        <input type="hidden" name="id_user" value="<?php echo $id_user;?>">
                        <div>
                            <center><img src="gambar/1069.jpg" alt="Gambar Obat"></center>

                            <div>
                                <center>
                                    <h2><br>Canesten Krim</h2>
                                </center>
                                <br>Rp. 19.000 /Pcs<br>
                                <p><br>Stock : 28</p>
                            ...
                            <div>
                                <h2>Deskripsi</h2>
                                <p>Canesten krim mengandung bahan aktif Klotrimazol 1%. Klotrimazol merupakan antijamur,
                                    sehingga Canesten krim dapat digunakan untuk mengobati secara topikal dari
                                    candidiasis, juga dapat digunakan untuk mengatasi ruam popok.</p>
                                <div class="divider"></div>
                            </div>
                            ...
                            <div>
                                <h2>Indikasi Umum</h2>
                                <p>Pengobatan topikal dari candidiasis, juga dapat digunakan untuk ruam popok.</p>
                                <div class="divider"></div>
                            </div>

                            <div>
                                <h2>Aturan Pakai</h2>
                                <p>Oleskan secukupnya 2-3 kali sehari.</p>
                                <div class="divider"></div>
                            </div>
                        </div>
                    </div>
