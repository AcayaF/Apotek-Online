            ...
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                <form class="login100-form validate-form" action="auth/aksi.php" method="post">
                    ...
                    <div class="product-list">
                        <input type="hidden" name="kode_obat" value="1031">
                        <input type="hidden" name="id_user" value="<?php echo $id_user;?>">
                        <div>
                            <center><img src="gambar/entrostop.jpg" alt="Gambar Obat"
                            ...
                            <div>
                                <h2>Deskripsi</h2>
                                <p>Entrostop merupakan obat yang digunakan untuk terapi simptomatik pada diare secara
                                    non spesifik atau kondisi diare yang tidak diketahui penyebabnya.</p>
                                <div class="divider"></div>
                            </div>

                            <div>
                                <h2>Komposisi</h2>
                                <p>Atapulgit 650 mg, Pektin 50 mg.</p>
                                <div class="divider"></div>
                            </div>
                            ...
                            <div>
                                <h2>Aturan Pakai</h2>
                                <p>> 12 th : 2 tablet setiap setelah buang air besar maksimum 12 tablet / 24 jam.</p>
                                <div class="divider"></div>
                            </div>
                        </div>
                    </div>
