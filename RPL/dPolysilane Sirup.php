            ...
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                <form class="login100-form validate-form" action="auth/aksi.php" method="post">
                    ...
                    <div class="product-list">
                        <input type="hidden" name="kode_obat" value="1014">
                        <input type="hidden" name="id_user" value="<?php echo $id_user;?>">
                        <div>
                            <center><img src="gambar/polysilane sirup.jpeg" alt="Gambar Obat"
                                    style="width:250px; height:150px;"></center>

                            <div>
                                <center>
                                    <h2><br>Polysilane Sirup</h2>
                                </center>
                                <br>Rp. 27.000 /Botol<br>
                                <p><br>Stock : 15</p>
                            ...
                            <div>
                                <h2>Deskripsi</h2>
                                <p>Polysilane sirup 100 mL diproduksi oleh PT. Pharos-Indonesia yang telah terdaftar
                                    pada BPOM. Polysilane sirup mengandung Mg(OH)2 200 mg, Al(OH)3 200 mg, dimethicone
                                    80 mg dalam tiap 5 mL. Polysilane dapat digunakan untuk mengurangi gejala yang
                                    berhubungan dengan kelebihan asam lambung, gastritis, tukak lambung, tukak usus 12
                                    jari, dengan gejala seperti mual, nyeri ulu hati, nyeri lambung, kembung, dan
                                    perasaan penuh pada lambung.</p>
                                <div class="divider"></div>
                            </div>

                            <div>
                                <h2>Komposisi</h2>
                                <p>Per 5 mL : Mg(OH)2 200 mg, Al(OH)3 200 mg, dimethicone 80 mg.</p>
                                <div class="divider"></div>
                            </div>

                            <div>
                                <h2>Indikasi Umum</h2>
                                <p>Untuk mengurangi gejala yang berhubungan dengan kelebihan asam lambung, gastritis,
                                    tukak lambung, tukak usus 12 jari, dengan gejala seperti mual, nyeri ulu hati, nyeri
                                    lambung, kembung, dan perasaan penuh pada lambung.</p>
                                <div class="divider"></div>
                            </div>

                            <div>
                                <h2>Aturan Pakai</h2>
                                <p>Dewasa :1-2 sendok takar 3-4 kali sehari; Anak 6-12 tahun : 1/2-1 sendok takar 3-4
                                    kali.</p>
                                <div class="divider"></div>
                            </div>
                        </div>
