            ...
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                <form class="login100-form validate-form" action="auth/aksi.php" method="post">
                    ...
                    <div class="product-list">
                        <input type="hidden" name="kode_obat" value="1020">
                        <input type="hidden" name="id_user" value="<?php echo $id_user;?>">
                        <div>
                            <center><img src="gambar/metrix.jpeg" alt="Gambar Obat" style="width:250px; height:150px;">
                            </center>
                            ...
                            <div>
                                <h2>Deskripsi</h2>
                                <p>Metrix 1mg untuk terapi diabetes tipe 2 dimana kadar gula darah tidak dapat dikontrol
                                    dengan diet dan olahraga.</p>
                                <div class="divider"></div>
                            </div>

                            <div>
                                <h2>Komposisi</h2>
                                <p>Glimepiride 1 mg.</p>
                                <div class="divider"></div>
                            </div>

                            <div>
                                <h2>Indikasi Umum</h2>
                                <p>Terapi diabetes tipe 2 dimana kadar gula darah tidak dapat dikontrol dengan diet dan
                                    olahraga.</p>
                                <div class="divider"></div>
                            </div>
                            ...
                            <div>
                                <h2>Aturan Pakai</h2>
                                <p>Dosis awal 1 mg 1x sehari pagi dapat ditingkatkan secara bertahap dg interval 1-2
                                    minggu.</p>
                                <div class="divider"></div>
                            </div>
                        </div>
