            ...
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                <form class="login100-form validate-form" action="auth/aksi.php" method="post">
                    ...
                    <div class="product-list">
                        <input type="hidden" name="kode_obat" value="1040">
                        <input type="hidden" name="id_user" value="<?php echo $id_user;?>">
                        <div>
                            <center><img src="gambar/1040.jpg" alt="Gambar Obat"></center>
                            ...
                            <div>
                                <h2>Deskripsi</h2>
                                <p>VALSARTAN termasuk obat golongan angiotensin II receptor blocker (ARB) yang bekerja
                                    dengan selektif pada reseptor subtipe AT1 yang bertanggung jawab atas efek yang
                                    disebabkan oleh angiotensin II serta merilekskan pembuluh darah sehingga darah dapat
                                    mengalir lebih lancar.</p>
                                <div class="divider"></div>
                            </div>
                            ...
                            <div>
                                <h2>Indikasi Umum</h2>
                                <p>-Hipertensi (dapat digunakan tunggal maupun dikombinasi dengan obat antihipertensi
                                    lain).<br>
                                    -Gagal jantung pada pasien yang tidak dapat mentoleransi obat penghambat ACE
                                    (penghambat enzim pengubah angiotensin).</p>
                                <div class="divider"></div>
                            </div>
