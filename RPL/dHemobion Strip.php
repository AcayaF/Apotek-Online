            ...
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                <form class="login100-form validate-form" action="auth/aksi.php" method="post">
                    ...
                    <div class="product-list">
                        <input type="hidden" name="kode_obat" value="1047">
                        <input type="hidden" name="id_user" value="<?php echo $id_user;?>">
                        <div>
                            <center><img src="gambar/1047.jpg" alt="Gambar Obat" style="width:250px; height:150px;">
                            </center>

                            <div>
                                <center>
                                    <h2><br>Hemobion Strip</h2>
                                </center>
                                <br>Rp. 30.000 /Strip<br>
                                <p><br>Stock : 40</p>
                            ...
                            <div>
                                <h2>Deskripsi</h2>
                                <p>Suplemen untuk mengatasi anemia pada kehamilan dan laktasi.</p>
                                <div class="divider"></div>
                            </div>

                            <div>
                                <h2>Komposisi</h2>
                                <p>Fe fumarate 360 mg, folic acid 1.5 mg, vit B12 15 mcg, vit C 75 mg, Ca carbonate 200
                                    mg, cholecalciferol 400 iu.</p>
                                <div class="divider"></div>
                            </div>

                            <div>
                                <h2>Indikasi Umum</h2>
                                <p>Anemia pd kehamilan & laktasi, anemia krn perdarahan, kehamilan.</p>
                                <div class="divider"></div>
                            </div>

                            <div>
                                <h2>Aturan Pakai</h2>
                                <p>1 x sehari 1 kapsul.</p>
                                <div class="divider"></div>
                            </div>
                        </div>
                    </div>
