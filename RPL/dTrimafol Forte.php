            ...
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                <form class="login100-form validate-form" action="auth/aksi.php" method="post">
                    ...
                    <div class="product-list">
                        <input type="hidden" name="kode_obat" value="1004">
                        <input type="hidden" name="id_user" value="<?php echo $id_user;?>">
                        <div>
                            <center><img src="gambar/Trimafol Forte.jpg" alt="Gambar Obat"
                                    style="width:250px; height:150px;"></center>

                            <div>
                                <center>
                                    <h2><br>Trimafol Forte</h2>
                                </center>
                                <br>Rp. 4.500 /Strip<br>
                                <p><br>Stock : 15</p>
                            ...
                            <div>
                                <h2>Deskripsi</h2>
                                <p>Trimafol Forte memiliki kandungan bahan aktif Paracetamol.
