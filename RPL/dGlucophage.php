            ...
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                <form class="login100-form validate-form" action="auth/aksi.php" method="post">
                    ...
                    <div class="product-list">
                        <input type="hidden" name="kode_obat" value="1019">
                        <input type="hidden" name="id_user" value="<?php echo $id_user;?>">
                        <div>
                            <center><img src="gambar/glucophage.jpeg" alt="Gambar Obat"
                            ...
                            <div>
                                <h2>Deskripsi</h2>
                                <p>Glucophage merupakan obat antidiabetes yang mengandung metformin hcl yang diproduksi
                                    oleh PT Merck Indonesia dan telah terdaftar di BPOM. Metformin adalah diabetes oral
                                    yang membantu mengontrol kadar gula darah. Glucophage digunakan untuk meningkatkan
                                    kontrol gula darah pada orang dengan diabetes tipe 2 . Glucophage kadang digunakan
                                    dalam kombinasi dengan insulin atau obat lain, tapi tidak untuk mengobati diabetes
                                    tipe 1.</p>
                                <div class="divider"></div>
                            </div>
                            ...
                            <div>
                                <h2>Indikasi Umum</h2>
                                <p>Pengobatan awal dm tipe 2 dg berat badan lebih dari normal dan mengalami gagal diet
                                    dan olah raga. Terapi tunggal bila terapi dengan sulfonilurea mengalami kegagalan,
                                    terapi kombinasi dg sulfonilurea. Terapi tambahan pada diabetes tipe 1 untuk
                                    menurunkan dosis insulin.</p>
                                <div class="divider"></div>
                            </div>

                            <div>
                                <h2>Aturan Pakai</h2>
                                <p>2 x sehari 1 tablet.</p>
                                <div class="divider"></div>
                            </div>
                        </div>
                    </div>
