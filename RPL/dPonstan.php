            ...
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                <form class="login100-form validate-form" action="auth/aksi.php" method="post">
                    ...
                    <div class="product-list">
                        <input type="hidden" name="kode_obat" value="1035">
                        <input type="hidden" name="id_user" value="<?php echo $id_user;?>">
                        <div>
                            <center><img src="gambar/ponstan.jpeg" alt="Gambar Obat" style="width:250px; height:150px;">
                            </center>
                            ...
                            <div>
                                <h2>Deskripsi</h2>
                                <p>Ponstan adalah obat yang mengandung Asam Mefenamat digunakan sebagai pereda nyeri,
                                    dismenore, nyeri ringan khususnya ketika pasien juga mengalami peradangan, dan
                                    mengurangi gangguan inflamasi (peradangan) secara umum.</p>
                                <div class="divider"></div>
                            </div>

                            <div>
                                <h2>Komposisi</h2>
                                <p>Asam mefenamat 500 mg.</p>
                                <div class="divider"></div>
                            </div>

                            <div>
                                <h2>Indikasi Umum</h2>
                                <p>Meredakan nyeri ringan sampai sedang, sehubungan dengan sakit kepala, sakit gigi,
                                    nyeri otot, termasuk nyeri trauma, dismenore primer, dan nyeri pasca operasi.</p>
                                <div class="divider"></div>
                            </div>

                            <div>
                                <h2>Aturan Pakai</h2>
                                <p>Dewasa : 4x sehari 1 tablet atau sesuai kebutuhan.</p>
                                <div class="divider"></div>
                            </div>
                        </div>
                    </div>
