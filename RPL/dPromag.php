            ...
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                <form class="login100-form validate-form" action="auth/aksi.php" method="post">
                    ...
                    <div class="product-list">
                        <input type="hidden" name="kode_obat" value="1013">
                        <input type="hidden" name="id_user" value="<?php echo $id_user;?>">
                        <div>
                            <center><img src="gambar/promag.jpg" alt="Gambar Obat"></center>

                            <div>
                                <center>
                                    <h2><br>Promag</h2>
                                </center>
                                <br>Rp. 7.500 /Strip<br>
                                <p><br>Stock : 16</p>
                            ...
                            <div>
                                <h2>Deskripsi</h2>
                                <p>Promag merupakan obat kombinasi antara antasida dengan simetikon yang digunakan untuk
                                    terapi dyspepsia (maag) dengan mengurangi gejala maag seperti kembung, mual, dan
                                    bersendawa. Promag mengandung antasida Magnesium (Mg(OH)) dan Hydrotalcite dengan
                                    Simetikon yang dapat menetralkan asam lambung dan mengurangi gas yang berlebihan di
                                    saluran pencernaan (antiflatulen).</p>
                                <div class="divider"></div>
                            </div>
                            ...
                            <div>
                                <h2>Indikasi Umum</h2>
                                <p>Untuk meringankan gejala yang berhubungan dengan kelebihan asam lambung, gastritis,
                                    tukak lambung, tukak usus 12 jari, dengan gejala seperti: mual, nyeri lambung, nyeri
                                    ulu hati, kembung dan perasaan penuh pada lambung.</p>
                                <div class="divider"></div>
                            </div>
