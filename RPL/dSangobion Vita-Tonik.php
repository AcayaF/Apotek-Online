            ...
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                <form class="login100-form validate-form" action="auth/aksi.php" method="post">
                    ...
                    <div class="product-list">
                        <input type="hidden" name="kode_obat" value="1044">
                        <input type="hidden" name="id_user" value="<?php echo $id_user;?>">
                        <div>
                            <center><img src="gambar/1044.jpg" alt="Gambar Obat"></center>

                            <div>
                                <center>
                                    <h2><br>Sangobion Vita-Tonik</h2>
                                </center>
                                <br>Rp. 40.000 /Botol<br>
                                <p><br>Stock : 18</p>
                            ...
                            <div>
                                <h2>Deskripsi</h2>
                                <p>SANGOBION VITA-TONIK merupakan suplemen penambah darah dengan tambahan vitamin untuk
                                    memenuhi kebutuhan vitamin harian. Dalam sediaan sirup dengan rasa manis cranberry.
                                </p>
                                <div class="divider"></div>
                            </div>
                            ...
                            <div>
                                <h2>Komposisi</h2>
                                <p>Per 15 ml ferrazone(Na feredetate) 113 mg,elemental Fe 15 mg,copper sulphate 45
                                    mcg,mangane sulphate 65mcg,vit B1 4 mg,vit B2 2,3 mg,Vit B3 15 MG,vit B5 4,5 mg,Vit
                                    B12 7,5mcg.</p>
                                <div class="divider"></div>
                            </div>
                            ...
                            <div>
                                <h2>Indikasi Umum</h2>
                                <p>Sebagai penambah darah dan membantu memperbaiki stamina tubuh.</p>
                                <div class="divider"></div>
                            </div>

                            <div>
                                <h2>Aturan Pakai</h2>
                                <p>2 sendok makan (30ml) sehari.</p>
                                <div class="divider"></div>
                            </div>
                        </div>
                    </div>
