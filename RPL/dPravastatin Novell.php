            ...
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                <form class="login100-form validate-form" action="auth/aksi.php" method="post">
                    ...
                    <div class="product-list">
                        <input type="hidden" name="kode_obat" value="1016">
                        <input type="hidden" name="id_user" value="<?php echo $id_user;?>">
                        <div>
                            <center><img src="gambar/pravastatin novell.jpeg" alt="Gambar Obat"
                                    style="width:250px; height:150px;"></center>

                            <div>
                                <center>
                                    <h2><br>Pravastatin Novell</h2>
                                </center>
                                <br>Rp. 39.000 /Strip<br>
                                <p><br>Stock : 6</p>
                            ...
                            <div>
                                <h2>Deskripsi</h2>
                                <p>Pravastatin sodium merupakan senyawa penurun lipid, bekerja secara kompetitif
                                    menghambat 3-hydroxy-3-methylglutaryl-coenzyme A (HMG Co-A) reductase, suatu enzim
                                    yang bekerja pada tahap awal biosintesa kolesterol, pada perubahan HMG Co-A menjadi
                                    mevalonat.</p>
                                <div class="divider"></div>
                            </div>
                            ...
                            <div>
                                <h2>Komposisi</h2>
                                <p>Pravastatin sodium 20mg.</p>
                                <div class="divider"></div>
                            </div>

                            <div>
                                <h2>Indikasi Umum</h2>
                                <p>Hiperlipidemia. Pravastatin diindikasikan sebagai tambahan pada diet untuk mengurangi
                                    peningkatan kadar total-C, LDL-C, Apo B, dan TG pada penderita hiperkolesterolemia
                                    primer dan campuran dislipidemia (Fredrickson tipe IIa dan IIb).</p>
                                <div class="divider"></div>
                            </div>

                            <div>
                                <h2>Aturan Pakai</h2>
                                <p>Dosis awal yang dianjurkan 10 mg atau 20 mg 1 x sehari pada malam hari. Penderita
                                    hiperkolesterolemia primer yang mempunyai sejarah penyakit disfungsi hati atau
                                    ginjal, orang tua : dosis awal yang dianjurkan 10 mg sehari pada malam hari.
                                    Pemberian bersama-sama dengan obat-obat immunosupresan (seperti siklosporin) dimulai
                                    dengan 10 mg pravastatin sekali sehari pada malam hari. Penyesuaian dosis
                                    selanjutnya dengan hati-hati.</p>
                                <div class="divider"></div>
                            </div>
                        </div>
                    </div>
