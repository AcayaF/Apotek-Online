        ...
        <div class="container-login100" style="background-image: url('images/bg-01.jpg');">
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                <form class="login100-form validate-form" action="auth/aksi.php" method="post">
                    ...
                    <input type="hidden" name="kode_obat" value="1023">
                        <input type="hidden" name="id_user" value="<?php echo $id_user;?>">
                        <div>
                            <center><img src="gambar/aclonac.jpg" alt="Gambar Obat" style="width:250px; height:150px;">
                            </center>
                            ...
                            <div>
                                <h2>Deskripsi</h2>
                                <p>Aclonac adalah obat dengan kandungan Kalium Diklofenak yang digunakan sebagai pereda
                                    nyeri, nyeri ringan hingga sedang pasca operasi khususnya ketika pasien juga
                                    mengalami peradangan, dan mengurangi gangguan inflamasi (peradangan) secara umum.
                                </p>
                                <div class="divider"></div>
                            </div>
                            ...
                            <div>
                                <h2>Komposisi</h2>
                                <p>Kalium Diklofenak.</p>
                                <div class="divider"></div>
                            </div>

                            <div>
                                <h2>Indikasi Umum</h2>
                                <p>Sebagai pengobatan jangka pendek untuk kondisi-kondisi akut sebagai berikut: nyeri
                                    inflamasi setelah trauma, seperti karena terkilir, nyeri dan inflamasi setelah
                                    operasi seperti operasi gigi atau tulang.</p>
                                <div class="divider"></div>
                            </div>

                            <div>
                                <h2>Aturan Pakai</h2>
                                <p>Dewasa: dosis awal 100-150 mg sehari, dosis terbagi 2-3 kali.</p>
                                <div class="divider"></div>
                            </div>
                        </div>
                    </div>
