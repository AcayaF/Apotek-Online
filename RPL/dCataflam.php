            ...
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                <form class="login100-form validate-form" action="auth/aksi.php" method="post">
                    ...
                    <div class="product-list">
                        <input type="hidden" name="kode_obat" value="1036">
                        <input type="hidden" name="id_user" value="<?php echo $id_user;?>">
                        <div>
                            <center><img src="gambar/cataflam.jpeg" alt="Gambar Obat"
                            ...
                            <div>
                                <h2>Deskripsi</h2>
                                <p>Cataflam adalah obat yang mengandung diclofenac potassium atau diclofenac sodium
                                    digunakan sebagai pereda nyeri, nyeri ringan hingga sedang pasca operasi khususnya
                                    ketika pasien juga mengalami peradangan, dan mengurangi gangguan inflamasi
                                    (peradangan) secara umum.</p>
                                <div class="divider"></div>
                            </div>

                            <div>
                                <h2>Komposisi</h2>
                                <p>Obat Cataflam mengandung diclofenac potassium 25 mg.</p>
                                <div class="divider"></div>
                            </div>

                            <div>
                                <h2>Indikasi Umum</h2>
                                <p>-Obat sakit gigi.<br>
                                    -Obat sakit kepala, migren, gusi bengkak.<br>
                                    -Meredakan nyeri punggung.<br>
                                    -Obat peradangan.<br>
                                    -Pereda nyeri haid.<br>
                                    -Obat Osteoarthritis.</p>
                                <div class="divider"></div>
                            </div>

                            <div>
                                <h2>Aturan Pakai</h2>
                                <p>-Meredakan nyeri: 50–100 mg 3 kali sehari.<br>
                                    -Meredakan keluhan Osteoarthritis: 50 mg 2–3 kali sehari.<br>
                                    -Meredakan keluhan rheumatoid arthritis: 50 mg 3–4 kali sehari.</p>
                                <div class="divider"></div>
                            </div>
                        </div>
                    </div>
