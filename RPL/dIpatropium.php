            ...
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                <form class="login100-form validate-form" action="auth/aksi.php" method="post">
                    ...
                    <div class="product-list">
                        <input type="hidden" name="kode_obat" value="1066">
                        <input type="hidden" name="id_user" value="<?php echo $id_user;?>">
                        <div>
                            <center><img src="gambar/1066.jpg" alt="Gambar Obat"></center>

                            <div>
                                <center>
                                    <h2><br>Ipatropium</h2>
                                </center>
                                <br>Rp. 185.000 /Pcs<br>
                                <p><br>Stock : 12</p>
                            ...
                            <div>
                                <h2>Deskripsi</h2>
                                <p>Ipratropium termasuk ke dalam obat golongan bronkodilator. Obat ini bekerja dengan
                                    cara mengendurkan otot di saluran pernapasan, sehingga udara dapat mengalir dengan
                                    lebih lancar dan penderita bisa bernapas dengan lebih mudah.</p>
                                <div class="divider"></div>
                            </div>
                            ...
                            <div>
                                <h2>Indikasi Umum</h2>
                                <p>Ipratropium atau ipratropium bromide adalah obat untuk meredakan dan mencegah gejala
                                    karena penyempitan saluran pernapasan (bronkospasme), seperti mengi atau sesak
                                    napas, akibat penyakit paru obstruktif kronik (PPOK).</p>
                                <div class="divider"></div>
                            </div>

                            <div>
                                <h2>Aturan Pakai</h2>
                                <p>-Dewasa dan anak-anak usia >12 tahun: 20–40 mcg, 3–4 kali sehari.<br>
                                    -Anak-anak usia 6–12 tahun: 20–40 mcg, 3 kali sehari.<br>
                                    -Anak-anak usia < 6 tahun: 20 mcg, 3 kali sehari.</p>
                                        <div class="divider"></div>
                            </div>
                        </div>
                    </div>
