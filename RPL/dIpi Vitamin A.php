            ...
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                <form class="login100-form validate-form" action="auth/aksi.php" method="post">
                    ...
                    <div class="product-list">
                        <input type="hidden" name="kode_obat" value="1049">
                        <input type="hidden" name="id_user" value="<?php echo $id_user;?>">
                        <div>
                            <center><img src="gambar/1049.jpg" alt="Gambar Obat"></center>

                            <div>
                                <center>
                                    <h2><br>Ipi Vitamin A</h2>
                                </center>
                            ...
                            <div>
                                <h2>Deskripsi</h2>
                                <p>Vitamin yang membantu mencegah dan mengobati gejala kekurangan vitamin A. Selain itu,
                                    vitamin A berfungsi untuk perkembangan dan kinerja berbagai organ tubuh, seperti
                                    mata, kulit dan sistem kekebalan tubuh.</p>
                                <div class="divider"></div>
                            </div>
                            ...
                            <div>
                                <h2>Indikasi Umum</h2>
                                <p>Membantu mencegah dan mengobati gejala kekurangan vitamin A.</p>
                                <div class="divider"></div>
                            </div>

                            <div>
                                <h2>Aturan Pakai</h2>
                                <p>Dewasa dan anak-anak: 1 tablet sehari.</p>
                                <div class="divider"></div>
                            </div>
                        </div>
                    </div>
