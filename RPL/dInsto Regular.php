            ...
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                <form class="login100-form validate-form" action="auth/aksi.php" method="post">
                    ...
                    <div class="product-list">
                        <input type="hidden" name="kode_obat" value="1061">
                        <input type="hidden" name="id_user" value="<?php echo $id_user;?>">
                        <div>
                            <center><img src="gambar/1061.jpg" alt="Gambar Obat"></center>

                            <div>
                                <center>
                                    <h2><br>Insto Regular</h2>
                                </center>
                            ...
                            <div>
                                <h2>Deskripsi</h2>
                                <p>INSTO EYE merupakan obat tetes mata yang digunakan untuk mata yang memerah, terasa
                                    pedih ataupun gatal karena iritasi ringan yang disebabkan oleh debu dan asap.</p>
                                <div class="divider"></div>
                            </div>

                            <div>
                                <h2>Komposisi</h2>
                                <p>Tetrahidrozolin hcl 0,05%, Benzalkonium chloride 0,01%.</p>
                                <div class="divider"></div>
                            </div>

                            <div>
                                <h2>Indikasi Umum</h2>
                                <p>Mata lelah, mata merah, mata perih, dan mata gatal karena iritasi debu, asap, angin,
                                    banyak membaca, setelah berenang.</p>
                                <div class="divider"></div>
                            </div>

                            <div>
                                <h2>Aturan Pakai</h2>
                                <p>Sehari 3-4 x 2-3 tetes pada setiap mata.</p>
                                <div class="divider"></div>
                            </div>
                        </div>
                    </div>
