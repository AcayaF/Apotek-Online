            ...
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                <form class="login100-form validate-form" action="auth/aksi.php" method="post">
                    ...
                    <div class="product-list">
                        <input type="hidden" name="kode_obat" value="1034">
                        <input type="hidden" name="id_user" value="<?php echo $id_user;?>">
                        <div>
                            <center><img src="gambar/dentasol.jpg" alt="Gambar Obat" style="width:250px; height:150px;">
                            </center>
                            ...
                            <div>
                                <h2>Deskripsi</h2>
                                <p>Dentasol merupakan obat gigi yang dapat digunakan untuk mengatasi radang gusi,
                                    sariawan, sakit gigi, sakit dari rangsangan tumbuh gigi. Dentasol berbentuk cairan
                                    yang penggunaannya dapat dioleskan dengan jari atau kapas. Dentasol mengandung zat
                                    anastesi topikal (bius lokal) dengan antiseptik yang dapat digunakan secara langsung
                                    pada area yang sakit.</p>
                                <div class="divider"></div>
                            </div>

                            <div>
                                <h2>Komposisi</h2>
                                <p>Benzokain 63 mg, setilpiridinium klorida 0,2 mg, kamfer 0,85 mg, mentol 0,77 mg,
                                    fenol 5 mg.</p>
                                <div class="divider"></div>
                            </div>
                            ...
                            <div>
                                <h2>Indikasi Umum</h2>
                                <p>Radang gusi, sariawan, sakit gigi, sakit dari rangsangan tumbuh gigi.</p>
                                <div class="divider"></div>
                            </div>

                            <div>
                                <h2>Aturan Pakai</h2>
                                <p>Oleskan dengan kapas diulangi setiap 3-4 jam.</p>
                                <div class="divider"></div>
                            </div>
                        </div>
                    </div>
