            ...
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                <form class="login100-form validate-form" action="auth/aksi.php" method="post">
                    ...
                    <div class="product-list">
                        <input type="hidden" name="kode_obat" value="1010">
                        <input type="hidden" name="id_user" value="<?php echo $id_user;?>">
                        <div>
                            <center><img src="gambar/inza.jpeg" alt="Gambar Obat" style="width:250px; height:150px;">
                            </center>
                            ...
                            <div>
                                <h2>Deskripsi</h2>
                                <p>Tablet untuk membantu meringankan gejala flu seperti demam, pusing, sakit kepala, dan
                                    bersin-bersin.</p>
                                <div class="divider"></div>
                            </div>
                            ...
                            <div>
                                <h2>Komposisi</h2>
                                <p>Parasetamol 500mg(125mg),Pseudoephedrin 30mg, Ctm 1mg(0,5mg).</p>
                                <div class="divider"></div>
                            </div>

                            <div>
                                <h2>Indikasi Umum</h2>
                                <p>Meringankan gejala flu,bersin-bersin,hidung tersumbat,sakit kepala.</p>
                                <div class="divider"></div>
                            </div>

                            <div>
                                <h2>Aturan Pakai</h2>
                                <p>Anak 6-12 tahun : 3 x sehari 1/2 tablet, Dewasa :3 x sehari 1 tablet.</p>
                                <div class="divider"></div>
                            </div>
                        </div>
                    </div>
