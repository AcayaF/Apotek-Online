            ...
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                <form class="login100-form validate-form" action="auth/aksi.php" method="post">
                    ...
                    <div class="product-list">
                        <input type="hidden" name="kode_obat" value="1033">
                        <input type="hidden" name="id_user" value="<?php echo $id_user;?>">
                        <div>
                            <center><img src="gambar/diatabs.jpg" alt="Gambar Obat" style="width:250px; height:150px;">
                            </center>
                            ...
                            <div>
                                <h2>Deskripsi</h2>
                                <p>Diatab merupakan obat yang digunakan untuk terapi simptomatik pada diare secara non
                                    spesifik atau kondisi diare yang tidak diketahui penyebabnya. New Diatab mengandung
                                    senyawa Attapulgite aktif dengan mekanisme kerja sebagai berikut: Attapulgite atau
                                    Magnesium Aluminium Pilosilikat biasa digunakan untuk mengobati diare dengan
                                    mengikat asam, zat beracun, bakteri atau kuman yang dapat menyebabkan diare.</p>
                                <div class="divider"></div>
                            </div>

                            <div>
                                <h2>Komposisi</h2>
                                <p>Attapulgit aktif 600 mg.</p>
                                <div class="divider"></div>
                            </div>

                            <div>
                                <h2>Indikasi Umum</h2>
                                <p>Pengobatan simptomatik pada diare yang tidak diketahui penyebabnya.</p>
                                <div class="divider"></div>
                            </div>

                            <div>
                                <h2>Aturan Pakai</h2>
                                <p>> 12 th 2 tablet setiap setelah buang air besar.</p>
                                <div class="divider"></div>
                            </div>
                        </div>
                    </div>
