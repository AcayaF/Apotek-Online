            ...
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                <form class="login100-form validate-form" action="auth/aksi.php" method="post">
                    ...
                    <div class="product-list">
                        <input type="hidden" name="kode_obat" value="1043">
                        <input type="hidden" name="id_user" value="<?php echo $id_user;?>">
                        <div>
                            <center><img src="gambar/1043.jpg" alt="Gambar Obat" style="width:250px; height:150px;">
                            </center>
                            ...
                            <div>
                                <h2>Deskripsi</h2>
                                <p>Bisoprolol Fumarate Novell adalah obat generik yang mengandung zat aktif Bisoprolol
                                    Fumarate dan digunakan untuk mengatasi hipertensi, angina pektoris akibat
                                    arteriosklerosis koroner, serangan jantung, dan penyakit gangguan kardiovaskular
                                    lainnya. Bisoprolol Fumarate termasuk golongan beta blocker yang bekerja dengan cara
                                    menghalangi respons dari stimulasi beta –adrenergik dan memiliki aktivitas sebagai
                                    antagonis reseptor beta1 selektif (kardioselektif) pada dosis rendah.</p>
                                <div class="divider"></div>
                            </div>

                            <div>
                                <h2>Komposisi</h2>
                                <p>Bisoprolol hemifumarat 5mg.</p>
                                <div class="divider"></div>
                            </div>

                            <div>
                                <h2>Indikasi Umum</h2>
                                <p>Hipertensi, baik sebagai monoterapi ataupun sebagai kombinasi dengan obat
                                    antihipertensi yang lain.</p>
                                <div class="divider"></div>
                            </div>

                            <div>
                                <h2>Aturan Pakai</h2>
                                <p>Kasus ringan : 1 tab/hari, sebagian besar 2 tab/hari, lebih berat 4 tab/hari.<br>
                                    Gagal ginjal/disfungsi hati : 2 tab/hari.</p>
                                <div class="divider"></div>
                            </div>
                        </div>
                    </div>
