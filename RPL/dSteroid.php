            ...
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                <form class="login100-form validate-form" action="auth/aksi.php" method="post">
                    ...
                    <div class="product-list">
                        <input type="hidden" name="kode_obat" value="1067">
                        <input type="hidden" name="id_user" value="<?php echo $id_user;?>">
                        <div>
                            <center><img src="gambar/1067.jpg" alt="Gambar Obat"></center>

                            <div>
                                <center>
                                    <h2><br>Steroid</h2>
                                </center>
                                <br>Rp. 31.000 /Botol<br>
                                <p><br>Stock : 3</p>
                            ...
                            <div>
                                <h2>Deskripsi</h2>
                                <p>Combivent merupakan obat yang digunakan untuk mencegah dan mengontrol gejala dari
                                    sesak napas atau mengi (wheezing) yang disebabkan oleh asma akut dan penyakit
                                    jantung.</p>
                                <div class="divider"></div>
                            </div>
                            ...
                            <div>
                                <h2>Komposisi</h2>
                                <p>1 vial mengandung ipratropium bromide 0,5 mg dan salbutamol 2,5 mg.</p>
                                <div class="divider"></div>
                            </div>

                            <div>
                                <h2>Indikasi Umum</h2>
                                <p>Untuk mengendalikan reversibel bronkospasma yang disebabkan oleh penyakit jantung
                                    maupun asma akut.</p>
                                <div class="divider"></div>
                            </div>
                            ...
                            <div>
                                <h2>Aturan Pakai</h2>
                                <p>Serangan akut : 1 ampul, maintenance : 1 ampul dipakai 3-4 x sehari.</p>
                                <div class="divider"></div>
                            </div>
                        </div>
                    </div>
