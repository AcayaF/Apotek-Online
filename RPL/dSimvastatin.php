            ...
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                <form class="login100-form validate-form" action="auth/aksi.php" method="post">
                    ...
                    <div class="product-list">
                        <input type="hidden" name="kode_obat" value="1015">
                        <input type="hidden" name="id_user" value="<?php echo $id_user;?>">
                        <div>
                            <center><img src="gambar/simvastatin.jpg" alt="Gambar Obat"
                                    style="width:250px; height:150px;"></center>

                            <div>
                                <center>
                                    <h2><br>Simvastatin</h2>
                                </center>
                                <br>Rp. 11.000 /Strip<br>
                                <p><br>Stock : 10</p>
                            ...
                            <div>
                                <h2>Deskripsi</h2>
                                <p>SIMVASTATIN termasuk obat golongan inhibitor reductase HMG CoA atau statin yang
                                    bekerja dengan cara menghambat enzim pembentuk kolesterol jahat sehingga kadar
                                    kolesterol dalam darah berkurang. Simvastatin mengurangi kadar kolesterol buruk
                                    (LDL) dan trigliserid dalam darah, sekaligus menaikkan kadar HDL (kolesterol baik)
                                    serta digunakan untuk menurunkan risiko kematian karena penyakit jantung koroner,
                                    menurunkan risiko infark miokard non fatal, menurunkan risiko pada pasien yang
                                    sedang menjalani tindakan revaskularisasi miokardial. Simvastatin dapat dikonsumsi
                                    sebelum atau sesudah makan pada malam hari, biasanya satu kali setiap hari di waktu
                                    malam sebelum tidur atau sesuai yang disarankan oleh dokter.</p>
                                <div class="divider"></div>
                            </div>
                            ...
                            <div>
                                <h2>Indikasi Umum</h2>
                                <p>Menurunkan kadar kolestrol total & LDL pada pasien dengan hiperkolesterolemia primer
                                    (tipe IIa & IIb).</p>
                                <div class="divider"></div>
                            </div>
