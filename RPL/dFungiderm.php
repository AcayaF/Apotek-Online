            ...
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                <form class="login100-form validate-form" action="auth/aksi.php" method="post">
                    ...
                    <div class="product-list">
                        <input type="hidden" name="kode_obat" value="1070">
                        <input type="hidden" name="id_user" value="<?php echo $id_user;?>">
                        <div>
                            <center><img src="gambar/1070.jpg" alt="Gambar Obat"></center>
                            ...
                            <div>
                                <h2>Deskripsi</h2>
                                <p>Sediaan topikal berspektrum luas untuk anti jamur.</p>
                                <div class="divider"></div>
                            </div>
                            ...
                            <div>
                                <h2>Indikasi Umum</h2>
                                <p>Infeksi jamur pada kulit dan kuku yang disebabkan oleh dermatofit, kandida, ragi-ragi
                                    jamur lainnya, dan memiliki khasiat antibakteri terhadap gram positif sehingga dapat
                                    digunakan pada mikosis dengan infeksi sekunder oleh bakteri.</p>
                                <div class="divider"></div>
                            </div>

                            <div>
                                <h2>Aturan Pakai</h2>
                                <p>Oleskan 2-3x sehari pada bagian yang sakit selama 10-14 hari secara teratur dan tidak
                                    berhenti.</p>
                                <div class="divider"></div>
                            </div>
                        </div>
