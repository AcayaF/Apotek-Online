            ...
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                <form class="login100-form validate-form" action="auth/aksi.php" method="post">
                    ...
                    <div class="product-list">
                        <input type="hidden" name="kode_obat" value="1003">
                        <input type="hidden" name="id_user" value="<?php echo $id_user;?>">
                        <div>
                            <center><img src="gambar/panadol biru.jpg" alt="Gambar Obat"></center>

                            <div>
                                <center>
                                    <h2><br>Panadol Biru</h2>
                                </center>
                                <br>Rp. 12.000 /Strip<br>
                                <p><br>Stock : 8</p>
                            ...
                            <div>
                                <h2>Deskripsi</h2>
                                <p>Panadol biru memiliki kandungan bahan aktif Paracetamol. Paracetamol bekerja dengan
                                    cara mengurangi kadar prostaglandin di dalam tubuh, sehingga tanda peradangan
                            ...
                            <div>
                                <h2>Aturan Pakai</h2>
                                <p>• Dewasa: 1-2 tablet, diberikan sebanyak 3-4 kali per hari.
                                    <br>• Anak usia 6-12 tahun: ½-1 tablet, diberikan sebanyak 3-4 kali per hari.
                                </p>
                                <div class="divider"></div>
                            </div>
                        </div>
