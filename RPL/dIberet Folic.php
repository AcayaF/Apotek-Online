            ...
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                <form class="login100-form validate-form" action="auth/aksi.php" method="post">
                    ...
                    <div class="product-list">
                        <input type="hidden" name="kode_obat" value="1046">
                        <input type="hidden" name="id_user" value="<?php echo $id_user;?>">
                        <div>
                            <center><img src="gambar/1046.jpg" alt="Gambar Obat" style="width:250px; height:150px;">
                            </center>

                            <div>
                                <center>
                                    <h2><br>Iberet Folic</h2>
                                </center>
                                <br>Rp. 45.000 /Strip<br>
                                <p><br>Stock : 36</p>
                            ...
                            <div>
                                <h2>Deskripsi</h2>
                                <p>IBERET FOLIC merupakan suplemen yang dapat digunakan untuk dewasa dan ibu hamil.
                                    Produk ini dapat digunakan untuk mengatasi anemia karena defisiensi Fe, anemia
                                    megaloblastik disertai defisiensi Vitamin C dan B Complex terutama pada kehamilan.
                                </p>
                                <div class="divider"></div>
                            </div>
                            ...
                            <div>
                                <h2>Komposisi</h2>
                                <p>Fe sulfate 525 mg, vit C 500 mg, niacinamide 30 mg, Ca pantothenate 10 mg, vit B1 6
                                    mg, vit B2 6 mg, vit B6 5 mg, vit B12 25 mcg, folic acid 800 mcg.</p>
                                <div class="divider"></div>
                            </div>

                            <div>
                                <h2>Indikasi Umum</h2>
                                <p>Anemia karena defisiensi Fe, anemia megaloblastik disertai defisiensi Vit.C & B
                                    Complex terutama pada kehamilan.</p>
                                <div class="divider"></div>
                            </div>

                            <div>
                                <h2>Aturan Pakai</h2>
                                <p>Pengobatan akibat defisiensi Fe & asam folat untuk Dewasa & ibu hamil : 1 tablet/
                                    hari, dapat diminum sebelum atau sesudah makan, telan utuh dan jangan
                                    dikunyah/dihancurkan.</p>
                                <div class="divider"></div>
                            </div>
                        </div>
                    </div>
