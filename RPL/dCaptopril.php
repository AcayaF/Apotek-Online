            ...
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                <form class="login100-form validate-form" action="auth/aksi.php" method="post">
                    ...
                    <div class="product-list">
                        <input type="hidden" name="kode_obat" value="1039">
                        <input type="hidden" name="id_user" value="<?php echo $id_user;?>">
                        <div>
                            <center><img src="gambar/1039.jpg" alt="Gambar Obat" style="width:250px; height:150px;">
                            </center>
                            ...
                            <div>
                                <h2>Deskripsi</h2>
                                <p>Captopril Indofarma merupakan obat generik yang digunakan untuk mengurangi tekanan
                            ...
                            <div>
                                <h2>Indikasi Umum</h2>
                                <p>Untuk hipertensi berat hingga sedang, gagal jantung yang tidak cukup responsif dengan
                                    diuretik dan digitalis.</p>
                                <div class="divider"></div>
                            </div>

                            <div>
                                <h2>Aturan Pakai</h2>
                                <p>Hipertensi : 3 kali sehari 12,5mg, bisa dinaikkan maksimal 450mg; Gagal jantung : 3 x
                                    sehari 12,5-25mg.</p>
                                <div class="divider"></div>
                            </div>
                        </div>
