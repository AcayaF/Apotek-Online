            ...
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                <form class="login100-form validate-form" action="auth/aksi.php" method="post">
                    ...
                    <div class="product-list">
                        <input type="hidden" name="kode_obat" value="1054">
                        <input type="hidden" name="id_user" value="<?php echo $id_user;?>">
                        <div>
                            <center><img src="gambar/1054.jpg" alt="Gambar Obat"></center>

                            <div>
                                <center>
                                    <h2><br>Ipi Vitamin B</h2>
                                </center>
                                <br>Rp. 6.000 /Botol<br>
                                <p><br>Stock : 18</p>
                            ...
                            <div>
                                <h2>Deskripsi</h2>
                                <p>Vitamin B Complex Ipi digunakan untuk mencegah dan mengobati kekurangan vitamin B
                                    complex. Cara kerja vitamin ini adalah mensuplai kebutuhan vitamin B complex yang
                                    penting untuk metabolisme karbohidrat dan protein dalam tubuh.</p>
                                <div class="divider"></div>
                            </div>

                            <div>
                                <h2>Komposisi</h2>
                                <p>Vitamin B1 (2 mg); Vitamin B2 (2 mg); Vitamin B6 (2 mg); Calcium Pantothenate (10
                                    mg), Nicotinamide (20 mg).</p>
                                <div class="divider"></div>
                            </div>

                            <div>
                                <h2>Indikasi Umum</h2>
                                <p>Mensuplasi kebutuhan vitamin B complex yang penting untuk metabolisme kabohidrat dan
                                    protein dalam tubuh.</p>
                                <div class="divider"></div>
                            </div>

                            <div>
                                <h2>Aturan Pakai</h2>
                                <p>1-2 tablet sehari.</p>
                                <div class="divider"></div>
                            </div>
                        </div>
                    </div>
