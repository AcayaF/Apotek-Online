            ...
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                <form class="login100-form validate-form" action="auth/aksi.php" method="post">
                    ...
                    <div class="product-list">
                        <input type="hidden" name="kode_obat" value="1052">
                        <input type="hidden" name="id_user" value="<?php echo $id_user;?>">
                        <div>
                            <center><img src="gambar/glodisa netravision.jpg" alt="Gambar Obat"
                                    style="width:250px; height:150px;"></center>

                            <div>
                                <center>
                                    <h2><br>Glodisa Netravision</h2>
                                </center>
                                <br>Rp. 10.000 /Botol<br>
                                <p><br>Stock : 10</p>
                            ...
                            <div>
                                <h2>Deskripsi</h2>
                                <p>Netravision Plus mengandung zat aktif Vitamin C, vitamin E, Zn, Cu, lutein,
                                    astaxanthin, dan omega 3. Netravision Plus digunakan untuk membantu mencegah
                                    kerusakan lensa mata, membantu mencegah retinopati diabetes, membantu menjaga
                                    kelembapan mata, dan membantu memelihara kesehatan mata.</p>
                                <div class="divider"></div>
                            </div>

                            <div>
                                <h2>Komposisi</h2>
                                <p>Vitamin C 250 mg, vitamin E 134 mg, Zn 15 mg, Cu 0.5 mg, lutein 5 mg, astaxanthin 1
                                    mg, dan omega 3 100 mg.</p>
                                <div class="divider"></div>
                            </div>

                            <div>
                                <h2>Indikasi Umum</h2>
                                <p>Netravision Plus digunakan untuk membantu memelihara kesehatan mata.</p>
                                <div class="divider"></div>
                            </div>

                            <div>
                                <h2>Aturan Pakai</h2>
                                <p>2 kapsul, diminum 1 kali sehari.</p>
                                <div class="divider"></div>
                            </div>
                        </div>
                    </div>
