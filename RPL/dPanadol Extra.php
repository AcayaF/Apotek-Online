            ...
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                <form class="login100-form validate-form" action="auth/aksi.php" method="post">
                    ...
                    <div class="product-list">
                        <input type="hidden" name="kode_obat" value="1027">
                        <input type="hidden" name="id_user" value="<?php echo $id_user;?>">
                        <div>
                            <center><img src="gambar/panadol extra.png" alt="Gambar Obat"
                                    style="width:250px; height:150px;"></center>

                            <div>
                                <center>
                                    <h2><br>Panadol Extra</h2>
                                </center>
                            ...
                            <div>
                                <h2>Deskripsi</h2>
                                <p>Panadol Extra merupakan obat yang digunakan untuk meredakan demam dan rasa nyeri atau
                                    sakit kepala. Panadol Extra mengandung zat aktif Paracetamol (Acetaminophen) yaitu
                                    zat aktif yang memiliki aktivitas sebagai penurun demam/antipiretik dan pereda
                                    nyeri/analgesik yang bekerja dengan cara menghambat pembentukan prostaglandin yaitu
                                    zat yang memicu nyeri dan demam di hipotalamus untuk meningkatkan pelepasan panas
                                    supaya suhu tubuh normal.</p>
                                <div class="divider"></div>
                            </div>

                            <div>
                                <h2>Komposisi</h2>
                                <p>Acetaminophen 500 mg, Caffeine 65 mg.</p>
                                <div class="divider"></div>
                            </div>
